...
$user_name = $_SESSION['ten_dang_nhap'] ?? 'Guest';

// Truy vấn danh sách đơn hàng
$sql = "SELECT * FROM don_hang WHERE nguoi_dung_id = ? ORDER BY ngay_dat DESC";
...
<head>
    ...
    <title>Đơn hàng của tôi - Louis Vuitton</title>
...
<main>
    ...
    <p class="show_shop_info_title">Đơn hàng của tôi</p>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['trang_thai'] ?: 'Chưa thanh toán'); ?></td>
