...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['hinh_anh']) && $_FILES['hinh_anh']['error'] == 0) {
        ...
        if ($hinh_anh && file_exists($_SERVER['DOCUMENT_ROOT'] . $hinh_anh)) {
            unlink($_SERVER['DOCUMENT_ROOT'] . $hinh_anh);
        }
    ...
    $sql = "UPDATE bai_viet SET tieu_de = '$tieu_de', noi_dung = '$noi_dung', hinh_anh = '$hinh_anh' WHERE id = '$id'";
...
<html lang="vi">
<head>
    <title>Sửa bài viết | Quản trị Admin</title>
    <meta charset="utf-8">
    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb">
                ...
                <li class="breadcrumb-item active"><b>Sửa bài viết</b></li>
            </ul>
            <div id="clock"></div>
        </div>
                    ...
                    <div class="tile-body">
                        <form method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="tieu_de" value="<?php echo htmlspecialchars($post['tieu_de']); ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Nội dung</label>
                                <textarea class="form-control" name="noi_dung" rows="5" required><?php echo htmlspecialchars($post['noi_dung']); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Hình ảnh hiện tại</label><br>
                                <?php if ($post['hinh_anh']) { ?>
                                    <img src="<?php echo $post['hinh_anh']; ?>" width="100"><br>
                                <?php } ?>
                                <label class="control-label">Thay hình ảnh</label>
